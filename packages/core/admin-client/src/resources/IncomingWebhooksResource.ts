...
export class IncomingWebhookCreatorCodec implements Codec<IncomingWebhookCreator> {
    public encode(from: IncomingWebhookCreator): object {
      return {
        ...
        [IncomingWebhookFields.RunAsUserIdScriptSource]: from.runAsUserIdScriptSource,
    ...
    public decode(from: object): IncomingWebhookCreator {
        return {
            ...
            runAsUserIdScriptSource: from[IncomingWebhookFields.RunAsUserIdScriptSource],
        }
    }
}
  ...
  export class IncomingWebhookResponseCodec implements Codec<IncomingWebhookResponse> {
...
export interface IncomingWebhookResponse {
  ...
  export class IncomingWebhooksResource extends BasicResource<IncomingWebhooksRoutes>
    implements Listable<IncomingWebhookResponse, IncomingWebhooksRoutes>, 
        Creatable<IncomingWebhookCreator, IncomingWebhookResponse, IncomingWebhooksRoutes> {
    public readonly codec = new IncomingWebhookResponseCodec();
    public readonly creatorCodec = new IncomingWebhookCreatorCodec();
  
    public create: (data: IncomingWebhookCreator) => Promise<IncomingWebhookResponse>;
