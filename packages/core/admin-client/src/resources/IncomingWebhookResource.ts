...
import { IncomingWebhookCreator, IncomingWebhookCreatorCodec, IncomingWebhookResponse, IncomingWebhookResponseCodec } from "./IncomingWebhooksResource";

export default class IncomingWebhookResource extends BasicResource<IncomingWebhookRoutes>
  implements Gettable<IncomingWebhookResponse, IncomingWebhookRoutes>,
  ...
  public update: (data: IncomingWebhookCreator) => Promise<IncomingWebhookCreator>;
