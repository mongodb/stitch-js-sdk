...
export default class AllowedRequestOriginsResource
  extends BasicResource<AllowedRequestOriginsRoutes>
  implements
    Gettable<string[], AllowedRequestOriginsRoutes>,
    Updatable<string[][], AllowedRequestOriginsRoutes> {
