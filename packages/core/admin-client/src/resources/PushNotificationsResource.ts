...
export class PushNotificationCreatorCodec
  implements Encoder<PushNotificationCreator> {
...
export class PushNotificationResponseCodec
  implements Codec<PushNotificationResponse> {
...
export class PushNotificationsResource
  extends BasicResource<PushNotificationsRoutes>
  implements
    Listable<PushNotificationResponse, PushNotificationsRoutes>,
    Creatable<
