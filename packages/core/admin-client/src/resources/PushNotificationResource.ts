...
import {
  ...
  PushNotificationResponseCodec
} from "./PushNotificationsResource";
...
export default class PushNotificationResource
  ...
  implements
    Gettable<PushNotificationResponse, PushNotificationRoutes>,
    Updatable<PushNotificationResponse, PushNotificationRoutes>,
    Removable<PushNotificationRoutes> {
