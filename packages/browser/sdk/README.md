...
```html
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.7.2/stitch.js"></script>
```
...
```html
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.7.2/stitch-core.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.7.2/stitch-services-aws.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.7.2/stitch-services-http.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.7.2/stitch-services-mongodb-remote.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.7.2/stitch-services-twilio.js"></script>
```
