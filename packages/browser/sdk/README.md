...
## Documentation
* [API/Typedoc Documentation](https://s3.amazonaws.com/stitch-sdks/js/docs/4.0.6/index.html)
...
```html
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch.js"></script>
```

For customized dependencies use the following:
```html
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch-core.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch-services-aws-s3.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch-services-aws-ses.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch-services-http.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch-services-mongodb-remote.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.6/stitch-services-twilio.js"></script>
```
