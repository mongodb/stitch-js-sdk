...
## Documentation
* [API/Typedoc Documentation](https://s3.amazonaws.com/stitch-sdks/js/docs/4.0.4/index.html)
...
```html
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch.js"></script>
```

For customized dependencies use the following:
```html
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch-core.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch-services-aws-s3.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch-services-aws-ses.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch-services-http.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch-services-mongodb-remote.js"></script>
<script src="https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.4/stitch-services-twilio.js"></script>
```
