...
const StitchUserProfileImpl_1 = require("../internal/StitchUserProfileImpl");
...
describe("StitchUserProfile", () => {
    ...
    it("should initialize", () => {
        const anonIdentity = new class extends StitchUserIdentity_1.default {
            constructor(id, providerType) {
                super(id, providerType);
            }
        }("id", "anon-user");
        const stitchUserProfileImpl = new StitchUserProfileImpl_1.default("local-userpass", ANON_USER_DATA, [anonIdentity]);
...
//# sourceMappingURL=StitchUserProfileUnitTests.js.map