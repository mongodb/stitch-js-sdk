exports.MongoClient = function () {
  ...
  return function MongoClient(db, appUrl) {
    this.getBaseArgs = function(action, collection, opts){
      var baseArgs = {
          action: action,
          arguments: {
            database: this.db,
      ...
      if (opts !== undefined && opts.rule !== undefined) {
        baseArgs.ruleName = opts.rule;
      }
      return baseArgs;
    };
    ...
    this.find = function(collection, query, project, callback, opts) {
      var body = this.getBaseArgs("find", collection, opts);
    ...
    this.remove = function( collection, query, singleDoc, callback, opts) {
      var body = this.getBaseArgs("delete", collection, opts);
      body.arguments["query"] = query;
      if (singleDoc) {
    ...
    this.insert = function(collection, documents, callback, opts) {
      var body = this.getBaseArgs("insert", collection, opts);
      body.arguments["documents"] = documents;
      this.execute(body, callback);
    };

    this.update = function(collection, query, _update, upsert, multi, callback, opts) {
      var body = this.getBaseArgs("update", collection, opts);
      body.arguments["query"] = query;
